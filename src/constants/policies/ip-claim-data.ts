...
const ipClaimData = {
  ...
  complaintLink: "https://forms.gle/ppJLj7LoCtmTVhQa6",
  sections: [
    {
      title: "INTELLECTUAL PROPERTY CLAIM",
      content: [
    ...
    {
      title: "A. PROCEDURE FOR REPORTING INTELLECTUAL PROPERTY INFRINGEMENT:",
      content: [
    ...
    },
    {
      ...
      content: [
        ...
        " ", // Add empty string for the newline
      ],
    },
    {
      title: "C. PROCEDURE TO SUPPLY A COUNTER-NOTICE TO THE DESIGNATED AGENT:",
      content: [
